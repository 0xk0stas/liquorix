...
export default {
  ...
  headerNavigationNetwork: 'header-navigation-network h-8 border border-secondary rounded-xl lg:h-10 relative w-22 flex items-center justify-center leading-none capitalize text-tertiary before:absolute before:rounded-full before:w-2 before:lg:w-2.5 before:h-2 before:lg:h-2.5 before:!bg-[#FF6900] before:z-2 before:-top-0.25 before:lg:-top-0.5 before:-left-0.25 before:lg:-left-0.5 after:absolute after:bg-primary after:rounded-lg after:opacity-40 after:left-0 after:right-0 after:top-0 after:bottom-0 after:pointer-events-none',
  ...
  headerNavigationConnectDesktop: 'header-navigation-connect-desktop h-11 hidden sm:block! bg-orange-600 hover:bg-orange-700 text-white border-0 rounded-xl px-6',
  headerNavigationConnectMobile: 'header-navigation-connect-mobile w-11 h-11 bg-btn-tertiary cursor-pointer flex justify-center items-center sm:hidden text-xs rounded-xl',
  headerNavigationConnectIcon: 'header-navigation-connect-icon text-accent',
  headerNavigationAddress: 'header-navigation-address h-11 w-8 lg:w-full text-primary justify-center text-xs rounded-xl lg:text-base lg:pr-4 lg:pl-5 max-w-100 flex relative lg:border lg:border-white/10 lg:rounded-xl items-center gap-3 after:absolute after:bg-white/5 after:rounded-xl after:left-0 after:right-0 after:top-0 after:bottom-0 after:pointer-events-none',
  headerNavigationAddressWallet: 'header-navigation-address-wallet relative z-1 text-[#FF6900] hidden lg:flex!',
