    ...
    Gas: TxGas<Env>,
{
    ...
    /// - `borrowed_token`: Token to be borrowed and swapped to collateral 
    ...
    ///  
    /// # Arguments 
    /// - `existing_borrowed_token`: Current debt token to be repaid and replaced 
    /// - `new_debt_amount_raw`: Amount of new debt token to borrow (raw units) 
    /// - `new_borrowed_token`: New debt token type to replace existing debt 
    ...
    >(
        self,
        existing_borrowed_token: Arg0,
        new_debt_amount_raw: Arg1,
        new_borrowed_token: Arg2,
        steps: Arg3,
    ) -> TxTypedCall<Env, From, To, (), Gas, ()> {
        self.wrapped_tx
            .raw_call("swapDebt")
            .argument(&existing_borrowed_token)
            .argument(&new_debt_amount_raw)
            .argument(&new_borrowed_token)
            .argument(&steps)
            .original_result()
    }
